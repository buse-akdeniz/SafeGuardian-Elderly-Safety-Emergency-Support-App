...
namespace AsistanApp.Services
{
    public class HealthDataService
    {
        ...
        public async Task<dynamic> AuthenticateElderly(string user, string pass) => await Task.FromResult<dynamic>(new { HasValue = true, Value = new { Token = "dummy", User = new { Id = 1 } } });
